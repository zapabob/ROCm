...
```{figure} ../../data/how-to/tuning-guides/tuning008.png
...
```{figure} ../../data/how-to/tuning-guides/tuning009.png
...
```{figure} ../../data/how-to/tuning-guides/image010.png
:name: mi200-rocminfo
...
```{figure} ../../data/how-to/tuning-guides/image011.png
...
```{figure} ../../data/how-to/tuning-guides/image012.png
...
```{figure} ../../data/how-to/tuning-guides/image013.png
